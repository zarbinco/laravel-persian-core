...
class ConfigValidator
{
    ...
    public function checks(): array
    {
        return [
            ...
            $this->stringCheck('bank_data.version', config('persian-core.bank_data.version')),
            $this->stringCheck('bank_data.source', config('persian-core.bank_data.source')),
            $this->booleanCheck('bank_data.strict_unknown', config('persian-core.bank_data.strict_unknown')),
